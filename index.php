				...
				while ($row = $query->fetch(PDO::FETCH_ASSOC)) { ?>
					<div class="col-lg-4 col-md-6 text-center">
						<div class="single-product-item">
							...
							<p class="product-price"><span>Designation: <?php echo $row['designation'] ?>  <br> Min PUC: <?php echo $row['min_puc'] ?>%  <br> Min Degree: <?php echo $row['min_degree'] ?>%<br>Location: <?php echo $row['location'] ?> <br>Eligible course: <?php echo $row['eligible_course'] ?></span> Salary: <?php echo $row['salary'] ?> RS</p>
