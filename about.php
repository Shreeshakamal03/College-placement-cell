				...
				<div class="col-lg-4">
					<div class="contact-form-wrap">
						<div class="contact-form-box">
							...
							<p>Vivekananda college of arts,science and commerce  <br> neharu nagar putturu,. <br> Karnataka</p>
						</div>
						<div class="contact-form-box">
							<h4><i class="far fa-clock"></i> Opening Hours</h4>
							<p>MON - FRI: 9 AM to 5 PM <br> SAT:9 AM to 1:30 PM</p>
						</div>
						<div class="contact-form-box">
							<h4><i class="fas fa-address-book"></i> Contact</h4>
							<p>Phone: +91 9724189879 <br> Email: support@vc.com</p>
						</div>
					</div>
				</div>
			</div>
